...
class RobotDemo : public SimpleRobot
{
	...
	BallHandle helev;
	GearTooth gt; // GET RID OF THIS SDFDSFDS
	
	int cycles;
	
	float p, i, d; // GET RID OF THIS SDHFSDAHF
	float old;  // GET RID OF THIS DSANHFSADHF
	float prpm;  //pervious rmp
	bool tole;  //tole switch to set motors
